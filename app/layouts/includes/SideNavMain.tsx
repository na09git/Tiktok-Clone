            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto">
                    ...
                    <div className="lg:block hidden text-[11px] text-gray-500">
                        <p className="pt-4 px-2">About Newsroom Nile Shop Contact Careers Niletech</p>
                        <p className="pt-4 px-2">Nile for Good Advertise Developers Transparency Nile Rewards Nile Browse Nile Embeds</p>
                        <p className="pt-4 px-2">Help Safety Terms Privacy Creator Portal Community Guidelines</p>
                        <p className="pt-4 px-2">© 2023 Nile</p>
                    </div>
